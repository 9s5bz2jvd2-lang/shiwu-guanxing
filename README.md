...
2. **Hero**——大字标题"食物观星"，中文副标题"营养科普 · 生活方式健康 · 星空探索"，英文辅助小字 "Food, Nutrition &amp; Stargazing Learning Hub"，下方写"作者 / Curated by：王润圆 Runyuan Wang"，并展示硕士、注册营养师、天文爱好者协会秘书处干事与公众号「圆酱说营养」。首页 CTA 第一项指向「权威指南与食养原文」。
3. **关于本站**——四张卡片：这是知识库不是个人主页；关于作者（含硕士、注册营养师、天文协会与公众号信息）；为什么营养与星空放在一起；本站不会做的事。
4. **权威指南与食养原文（#source-guides）**——把"主题导引"卡片背后的公开来源集中起来，5 张资料卡指向中国居民膳食指南（2022，CNS 入口）、国家卫健委 2024 与 2023 两批食养指南通知页（含成人肥胖 / 儿童青少年肥胖 / 高脂血症 / 高血压等的原文 PDF）、2024 高血压等慢病营养和运动指导原则、2024 体重管理指导原则；同 section 内附「本站 AI 食养 skill / 资料包说明」4 张方向卡（儿童青少年肥胖食养助手、成人肥胖食养工作台、食养 Agent 方法论、观星夜宵 · 夜间情境营养），仅列方向 / 适用范围 / 不做的事，不展示内部实现。
5. **营养资料库**——按主题筛选（成人肥胖 / 儿童青少年肥胖 / 维生素 D / 生活方式医学 / 膳食指南），可关键字搜索；每条卡片附公开来源类型，并把读者导引回到「权威指南与食养原文」直达链接。
6. **小工具 · 营养科普计算器**——BMI、一日能量需求粗估、三大宏量比例提示、钠 / 膳食纤维自查；全部在浏览器本地计算。
7. **营养与星空（Astronomy &amp; Nutrition）**——6 张科普卡片 + 「为什么营养师也关心星空？」短文 + NASA/IAU 公开资源链接。
8. **观星夜宵（Night Snack for Stargazers）**——面向夜间观星、马路天文、流星雨守候、通宵拍星 / 值守等场景的 6 张轻负担夜宵卡 + 选择小原则 + **真实文献来源**（Bonnell 等 Nutrients 2019、D'Annibale 等 Nutrition Bulletin 2021、CDC/NIOSH 夜班护士膳食建议、中国居民膳食指南 2022）。不是减肥处方，也不是医学治疗。
9. **本月星空 · 免费天象来源**——本月可看什么（人工维护示例 + 发布前按 NASA What's Up / AMS 更新）+ 4 个免费公开来源链接（NASA What's Up、AMS 流星雨日历、Timeanddate 月相、NASA Night Sky Network）+ 本地月相粗估小工具（不调用任何外部 API）。
10. **AI 营养工具探索**——基本立场：AI 是助手不是出口；不替代医生与临床营养师。
11. **免责声明**——明确不是医疗器械、不诊疗、特殊人群请就医。
...
3. 顶部导航与 Hero CTA 都能看到「指南原文 / 查权威指南原文」按钮，点击后定位到 #source-guides。
4. 滚到「权威指南与食养原文」，能看到 5 张资料卡（中国居民膳食指南 2022、NHC 2024 食养指南、NHC 2023 食养指南、2024 高血压等慢病营养与运动指导原则、2024 体重管理指导原则），每张都至少有一个外链按钮可以点开通知页或 PDF；下方还有 4 张 skill 方向卡（儿童青少年肥胖食养助手、成人肥胖食养工作台、食养 Agent 方法论、观星夜宵 · 夜间情境营养）。
5. 滚到"营养资料库"，点几次顶部的主题标签，下面的卡片应该跟着筛选；在搜索框里输入"维生素"，列表应该收窄；卡片底部的「权威指南与食养原文」链接能跳回上方 section。
6. 滚到"小工具"，填入身高、体重、年龄、活动水平等数字，下方应该给出 BMI、能量、宏量、钠 / 纤维提示。
7. 滚到"营养与星空"，深色背景上能看到 6 张卡片和"为什么营养师也关心星空？"小段，下面有 NASA / IAU 的来源链接（可不点击）。
8. 滚到"观星夜宵"，能看到 6 张场景卡（流星雨守候 / 高海拔冬夜 / 马路天文 / 月圆轻食 / 通宵拍星 / 回家助眠），下面有"夜宵选择小原则"与"真实参考来源"两块。
9. 滚到"本月星空 · 免费天象来源"，深色背景上有三张卡：本月可看什么、免费公开来源链接、月相粗估小工具；选一个日期能看到月相名 + 亮面比例。
10. 滚到底部，能看到「作者 / Curated by：王润圆 Runyuan Wang」、公众号「圆酱说营养」与免责声明。
...
- **新增 / 维护权威指南卡**：编辑 `index.html` 里 `id="source-guides"` 那个 section 的 `.guide-card` 块——直接复制一张卡片，改标题、机构 + 年份小标签、说明、覆盖范围、外链（通知页 / PDF）。原则上**只放官方通知页与原文 PDF**，不要放转载站或自媒体链接；如官方更新了文件名 / 路径，请同步更新链接并在 commit 信息中写明日期。
- **新增 / 维护 skill 卡**：编辑 `index.html` 里 `id="skill-pack"` 区块的 `.skill-card` 卡片——只写「方向 / 基于哪些公开材料 / 适合 / 不做」四段，**不要**把内部提示词、内部资料索引、工程参数或评测细节贴出来。
...
- **权威指南与食养原文**模块的链接均指向：中国营养学会膳食指南专栏（dg.cnsoc.org）、国家卫生健康委员会官网（nhc.gov.cn）公开通知页与配套 PDF。本站只在普通超链接里指向这些公开来源，**不调用任何外部 API、不加载任何外部脚本、不复制原文大段内容**。
- **观星夜宵**板块的真实参考来源：
